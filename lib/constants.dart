...
final kPolicyIntro =
    """Animist Team ("us", "we", or "our") operates the Animist mobile application (the "Service").
...
final kContact = RichText(
    text: TextSpan(
      ...
      TextSpan(
          text: 'animistapp@protonmail.com',
          style: TextStyle(
...
final kAdOptions = NativeAdmobOptions(
